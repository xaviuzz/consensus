...
function getHighlightsFromVChild({ content, matches: [[start, end]] }) {
...
var Patcher = class {
  constructor(plugin) {
    ...
    this.searchResultItemPatched = false;
    this.renderContentMatchesPatched = false;
          ...
          return function(...args) {
            ...
            try {
              const matchPositions = this.vChildren._children.map(
                ...
                ({ content, matches: [[start, end]] }) => createPositionFromOffsets(content, start, end)
              );
